        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=payment" class="nav-link <?php echo (@$_GET['page'] == 'payment') ? 'active' : '';?>">
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=search" class="nav-link <?php echo (@$_GET['page'] == 'search') ? 'active' : '';?>">
