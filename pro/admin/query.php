                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
							...
							?>
                            <div class="col-6 col-md-3 text-center">
							<input type="text" readonly class="knob" value="<?php echo $used; ?>" data-skin="tron" data-thickness="0.1" 	data-width="90" data-height="90" data-fgColor="#00a65a">
                                <div class="knob-label"><?php echo $state_id ?></div>
                            </div>
							
							<?php
								$fetch_hos = $conn->query("SELECT  	npc_reg_data.hospital_name AS state_id, COUNT(individual.registered_by) as c from individual
								INNER JOIN npc_reg_data ON npc_reg_data.id = individual.registered_by
								WHERE individual.registered_by != 'Self' GROUP by individual.registered_by ORDER by COUNT(*) desc LIMIT 1");
                    ...
                    <div class="card-body">
                        <div class="row">
                            <?php
								...
								$val = substr($val, 0, 4);
								++$del;
								echo ' <a href="admin.php?page=query&name=' . $row['state'] . '&cat=state&id=' . $row['id'] . 	'">                     
								<div class="col-2 col-md-2 text-center">
 
								<input type="text" readonly class="knob" value="' . $val . '" data-skin="tron" data-width="90" data-height="90" data-fgColor="#00a65a">
