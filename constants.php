...
$paystack = "sk_test_149d2068d25185d6cc28a754a3b08750f59662b3"; //Do not change this! Redirect URL http://localhost/train/pro/verify.php
...
function printClearance($id)
{
    ...
    class MYPDF extends TCPDF
    {
        ...
        public function Header()
        {
            ...
            // set bacground image
            $img_file = K_PATH_IMAGES . "watermark.png";
            // die($img_file);
...
<h1 style="text-align:center"><img src="images/trainlg.png" width="100" height="100"/><br/>KEFFI MOTOR PARK<br/>CAR TICKET</h1> <div style="text-align:right; font-family:courier;font-weight:bold"><font size="+6">Ticket N<u>o</u>: $uniqueCode </font></div>
...
<tr><th><b>Car:</b></th><td>$train</td></tr>
...
<tr><td colspan="2" style="text-align:center"><font size="-3"><i><em><strong>NOTE: </strong></em> Be an hour early for all neccessary proceedings Thank You! </i></font></td></tr>
...
function printReport($id)
{
    ...
    // die($result);
    $file_name = preg_replace('/[^a-z0-9]+/', '-', strtolower('car_booking')) . ".pdf";
    require_once 'PDF/tcpdf_config_alt.php';
    ...
    $pdf->SetCreator(PDF_CREATOR);
    $pdf->SetAuthor("Admin");
    $pdf->SetTitle("Car Bookings " . " Ticket");
    $pdf->SetSubject(SITE_NAME);
    $pdf->SetKeywords("Train Booking System, Rail, Rails, Railway, Booking, Project, System, Website, Portal ");
    ...
    $pdf->setTextShadow(array('enabled' => true, 'depth_w' => 0.2, 'depth_h' => 0.2, 'color' => array(196, 196, 196), 'opacity' => 1, 'blend_mode' => 'Normal'));
    // Set some content to print
    $html = '<h5 style="text-align:center"><img src="images/trainlg.png" width="80" height="80"/><br/>KEFFI MOTOR PARK<br/> LIST OF BOOKINGS  FOR ' . $date . ' (' . $time . ')</h5> <div style="text-align:right; font-family:courier;font-weight:bold"><font size="+1">Car ' . $train . ' (' . $sn . ' Passengers) : ' . $schedule . ' </font></div>' . $result;
    // die($html);
    // Print text using writeHTMLCell()
    $pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, '', true);
    // ---------------------------------------------------------
